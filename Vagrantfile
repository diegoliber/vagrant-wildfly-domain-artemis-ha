...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'slave1' do |v|
    ...
    v.vm.network 'private_network', ip: '172.28.128.21'
  end

  config.vm.define 'slave2' do |v|
    v.vm.host_name = 'slave2'
    v.vm.network 'private_network', ip: '172.28.128.22'
  end

  config.vm.define 'slave3' do |v|
    v.vm.host_name = 'slave3'
    v.vm.network 'private_network', ip: '172.28.128.23'
  end

  config.vm.define 'slave4' do |v|
    v.vm.host_name = 'slave4'
    v.vm.network 'private_network', ip: '172.28.128.24'
  end
